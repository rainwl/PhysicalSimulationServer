...
#pragma region Output
		std::cout << "endoscope_pos" << fusion_data.endoscope_pos().x() << ",";
		std::cout << fusion_data.endoscope_pos().y() << ",";
		std::cout << fusion_data.endoscope_pos().z() << "\n";
		std::cout << "endoscope_euler" << fusion_data.endoscope_euler().x() << ",";
		std::cout << fusion_data.endoscope_euler().y() << ",";
		std::cout << fusion_data.endoscope_euler().z() << "\n";
		std::cout << "tube_pos" << fusion_data.tube_pos().x() << ",";
		std::cout << fusion_data.tube_pos().y() << ",";
		std::cout << fusion_data.tube_pos().z() << ",";
		std::cout << "tube_euler" << fusion_data.tube_euler().x() << ",";
		std::cout << fusion_data.tube_euler().y() << ",";
		std::cout << fusion_data.tube_euler().z() << "\n";
		std::cout << "endoscope_offset" << fusion_data.offset().endoscope_offset() << "\n";
		std::cout << "tube_offset" << fusion_data.offset().tube_offset() << "\n";
		std::cout << "instrument_switch" << fusion_data.offset().instrument_switch() << "\n";
		std::cout << "animation_value" << fusion_data.offset().animation_value() << "\n";
		std::cout << "pivot_offset" << fusion_data.offset().pivot_offset() << "\n";
		std::cout << "rot_coordinate" << fusion_data.rot_coord().x() << ",";
		std::cout << fusion_data.rot_coord().y() << ",";
		std::cout << fusion_data.rot_coord().z() << ",";
		std::cout << fusion_data.rot_coord().w() << "\n";
		std::cout << "pivot_pos" << fusion_data.pivot_pos().x() << ",";
		std::cout << fusion_data.pivot_pos().y() << ",";
		std::cout << fusion_data.pivot_pos().z() << "\n";
		std::cout << "ablation_count" << fusion_data.ablation_count() << "\n";
		std::cout << "haptic_state" << fusion_data.haptic().haptic_state() << "\n";
		std::cout << "haptic_offset" << fusion_data.haptic().haptic_offset() << "\n";
		std::cout << "haptic_force" << fusion_data.haptic().haptic_force() << "\n";
		std::cout << "hemostasis_count" << fusion_data.hemostasis_count() << "\n";
		std::cout << "hemostasis_index" << fusion_data.hemostasis_index() << "\n";
		std::cout << "liga_flavum" << fusion_data.soft_tissue().liga_flavum() << "\n";
		std::cout << "disc_yellow_space" << fusion_data.soft_tissue().disc_yellow_space() << "\n";
		std::cout << "veutro_vessel" << fusion_data.soft_tissue().veutro_vessel() << "\n";
		std::cout << "fat" << fusion_data.soft_tissue().fat() << "\n";
		std::cout << "fibrous_rings" << fusion_data.soft_tissue().fibrous_rings() << "\n";
		std::cout << "nucleus_pulposus" << fusion_data.soft_tissue().nucleus_pulposus() << "\n";
		std::cout << "p_longitudinal_liga" << fusion_data.soft_tissue().p_longitudinal_liga() << "\n";
		std::cout << "dura_mater" << fusion_data.soft_tissue().dura_mater() << "\n";
		std::cout << "nerve_root" << fusion_data.soft_tissue().nerve_root() << "\n";
		std::cout << "nerve_root_dance" << fusion_data.nerve_root_dance() << "\n";
		std::cout << "\n";
#pragma endregion
	}
	eCAL::Finalize();
